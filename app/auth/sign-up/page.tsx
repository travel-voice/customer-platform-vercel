...
export default function SignUpPage() {
  ...
  const { register, loginWithGoogle, error, clearError, isLoading } = useAuthStore();
  ...
  const onSubmit = async (data: SignUpFormData) => {
    ...
    try {
      ...
      // Submit to HubSpot; await to avoid losing the request on navigation
      await fetch('/api/hubspot/submit-signup', {
        method: 'POST',
        ...
        body: JSON.stringify({
          ...
          email: data.email,
          companyname: data.organisation_name,
        }),
      }).catch(() => {});
            ...
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-5">
              ...
              <motion.div variants={fadeInVariants}>
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel className="text-gray-700 font-medium">Organisation name</FormLabel>
                      <FormControl>
                        <div className="relative">
